...
class NewUserForm(FlaskForm):
    ...
    id_number = StringField(u'身份证号', validators=[Required()])
    # high school
    high_school = StringField(u'毕业高中')
    cee_total = IntegerField(u'高考总分')
    cee_math = IntegerField(u'高考数学')
    cee_english = IntegerField(u'高考英语')
    high_school_year = SelectField(u'入学年份', coerce=unicode)
    # bachelor
    bachelor_school = StringField(u'本科学校')
    bachelor_major = StringField(u'院系（专业）')
    bachelor_gpa = FloatField(u'GPA')
    bachelor_full_gpa = FloatField(u'GPA满分')
    bachelor_year = SelectField(u'入学年份', coerce=unicode)
    # master
    master_school = StringField(u'研究生学校（硕士）')
    master_major = StringField(u'院系（专业）')
    master_gpa = FloatField(u'GPA')
    master_full_gpa = FloatField(u'GPA满分')
    master_year = SelectField(u'入学年份', coerce=unicode)
    # doctor
    doctor_school = StringField(u'研究生学校（博士）')
    doctor_major = StringField(u'院系（专业）')
    doctor_gpa = FloatField(u'GPA')
    doctor_full_gpa = FloatField(u'GPA满分')
    doctor_year = SelectField(u'入学年份', coerce=unicode)
    # scores
    cet_4 = IntegerField(u'CET-4')
    cet_6 = IntegerField(u'CET-6')
    tem_4 = IntegerField(u'TEM-4')
    tem_8 = IntegerField(u'TEM-8')
    ...
    competition = StringField(u'竞赛成绩')
    other_score = StringField(u'其它成绩')
    # job 1
    employer_1 = StringField(u'工作单位')
    position_1 = StringField(u'职务')
    job_year_1 = SelectField(u'入职年份', coerce=unicode)
    # job 2
    employer_2 = StringField(u'工作单位')
    position_2 = StringField(u'职务')
    ...
    emergency_contact_mobile = StringField(u'联系方式', validators=[Required()])
    # registration
    purposes = SelectMultipleField(u'研修目的', coerce=unicode)
    other_purpose = StringField(u'其它研修目的')
    application_major = StringField(u'申请方向')
    referrers = SelectMultipleField(u'了解渠道', coerce=unicode)
    other_referrer = StringField(u'其它了解渠道')
    inviter_email = StringField(u'推荐人（邮箱）')
