...
class Role(db.Model):
    ...
    def insert_roles():
        roles = [
            ...
            (u'协管员', [u'管理', u'管理课程预约', u'管理iPad借阅', u'管理预约时段', u'管理iPad设备', u'管理作业', u'管理考试', u'管理通知', u'管理站内信', u'管理反馈', u'管理进站', u'管理用户'], ),
            (u'管理员', [u'管理', u'管理课程预约', u'管理iPad借阅', u'管理预约时段', u'管理iPad设备', u'管理作业', u'管理考试', u'管理通知', u'管理站内信', u'管理反馈', u'管理进站', u'管理用户', u'管理权限'], ),
            (u'开发人员', [u'管理', u'管理课程预约', u'管理iPad借阅', u'管理预约时段', u'管理iPad设备', u'管理作业', u'管理考试', u'管理通知', u'管理站内信', u'管理反馈', u'管理进站', u'管理用户', u'管理权限', u'开发权限'], ),
        ]
        for R in roles:
