...
Revision ID: c8434e1627b3
Revises: 
Create Date: 2016-11-28 06:24:07.043133
...
def upgrade():
    ...
    sa.Column('emergency_name', sa.Unicode(length=64), nullable=True),
    sa.Column('emergency_relationship_id', sa.Integer(), nullable=True),
    sa.Column('emergency_mobile', sa.Unicode(length=64), nullable=True),
    ...
    sa.Column('vb_y_gre_together_offer', sa.Boolean(), nullable=True),
    sa.Column('undergraduate_refund', sa.Boolean(), nullable=True),
    sa.Column('alumni_refund', sa.Boolean(), nullable=True),
    sa.Column('special_offer', sa.Boolean(), nullable=True),
    sa.Column('other_offer', sa.Boolean(), nullable=True),
    sa.ForeignKeyConstraint(['emergency_relationship_id'], ['relationships.id'], ),
    ...
    sa.PrimaryKeyConstraint('inviter_id', 'invited_id')
    )
